...
if __name__ == "__main__":
    ...
    for i in range(0, len(examples) / 3):
        if i == 0:
            image_writer.write(examples[i].SerializeToString())
            print "image choose to be individual example is: ", pic_choosen[i]
    ...
    print "test pic num is: ", test_count
    train_writer.close()
    test_writer.close()
